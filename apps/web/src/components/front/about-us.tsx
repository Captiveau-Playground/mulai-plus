          ...
          <div className="flex flex-1 justify-center lg:justify-end">
            <div className="flex gap-4 sm:gap-6 md:gap-9">
              ...
              <div className="flex flex-col gap-4 sm:gap-6 md:gap-9">
                <div className="relative h-[280px] w-[160px] overflow-hidden rounded-2xl sm:h-[360px] sm:w-[220px] md:h-[454px] md:w-[328px]">
                  <Image src="/about-us/image-1.png" alt="Mentoring Session" fill className="object-cover" />
                </div>
                <div className="flex h-[100px] w-[160px] flex-col items-center justify-center rounded-2xl bg-[#FE9114] text-white sm:h-[120px] sm:w-[220px] md:h-[151px] md:w-[328px]">
              ...
              {/* Column 2 - Offset Top */}
              <div className="flex flex-col gap-4 pt-12 sm:gap-6 sm:pt-16 md:gap-9 md:pt-24">
                <div className="flex h-[100px] w-[160px] flex-col items-center justify-center rounded-2xl bg-[#F93447] text-white sm:h-[120px] sm:w-[220px] md:h-[151px] md:w-[328px]">

...
export function HeroSection() {
  return (
    <section className="relative flex min-h-svh w-full flex-1 flex-col justify-between overflow-hidden bg-white pt-28 md:pt-32 lg:pt-40">
      {/* Hero Content */}
      <div className="container relative z-10 mx-auto flex max-w-[1052px] flex-col items-start gap-6 px-4 text-center md:gap-8 md:px-6 lg:items-center lg:gap-10 lg:px-0">
        <div className="flex flex-col items-start gap-4 md:gap-6 lg:items-center">
          ...
          <p className="max-w-[993px] text-left font-manrope text-[#888888] text-lg md:text-xl lg:text-center lg:text-2xl">

  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          className="absolute -top-48 -right-48 h-[500px] w-[500px] rounded-full opacity-[0.06] md:h-[700px] md:w-[700px]"
          style={{ background: "var(--brand-orange)" }}
        />
        <div
          className="absolute -bottom-48 -left-48 h-[400px] w-[400px] rounded-full opacity-[0.04] md:h-[600px] md:w-[600px]"
          style={{ background: "var(--brand-navy)" }}
        />
      </div>

      <div className="container relative z-10 mx-auto flex max-w-7xl flex-1 flex-col justify-center gap-6 px-4 md:gap-8 md:px-6 lg:px-0">
        {/* ── Eyebrow ── */}
        ...
        >
          <span className="text-brand-red">Temukan Jurusan &amp; PTN</span> Impianmu dengan Data Real-time &amp; Mentor
          Personal
        </motion.h1>
        ...
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="mt-4 flex items-center gap-2 font-manrope text-text-muted/50 text-xs md:mt-6"
        >

...
export function CTASection() {
  return (
    <section className="w-full bg-white px-6 py-16 lg:px-32 lg:pt-16 lg:pb-[108px]">
      <div className="relative flex h-[500px] w-full flex-col justify-center overflow-hidden rounded-[48px] bg-[#F93447] px-8 py-12 md:h-[600px] md:px-16 lg:h-[700px] lg:justify-start lg:py-32">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(to left, rgba(254, 145, 20, 0) 22%, rgba(251, 99, 46, 0.57) 50%, #F93447 76%)",
          }}
        />

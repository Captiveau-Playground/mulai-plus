...
import { Dialog, DialogContent, DialogTitle, DialogTrigger } from "@/components/ai-elements/ui/dialog";
...
export const ModelSelectorLogo = ({ provider, className, ...props }: ModelSelectorLogoProps) => (
  // biome-ignore lint/performance/noImgElement: vendor Vercel AI-Elements
  <img
    {...props}
    alt={`${provider} logo`}

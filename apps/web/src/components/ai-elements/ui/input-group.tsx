...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: kode vendor Vercel AI-Elements
    <div
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: kode vendor Vercel AI-Elements
    // biome-ignore lint/a11y/useKeyWithClickEvents: kode vendor Vercel AI-Elements
    <div
      role="group"
...
const inputGroupButtonVariants = cva("flex min-w-0 items-center gap-2 text-sm shadow-none", {
  variants: {
    size: {

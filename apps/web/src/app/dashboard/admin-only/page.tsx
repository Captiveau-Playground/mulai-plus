    ...
    return (
      <div className="flex h-[calc(100vh-4rem)] flex-col items-center justify-center gap-4">
        ...
        <p className="text-muted-foreground">
          You need permission '<span className="font-bold font-mono text-foreground">access:admin_dashboard</span>' to
          view this page.
        </p>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            ...
            <span className="font-bold font-mono text-foreground">access:admin_dashboard</span> (or you are an Admin).
          </p>

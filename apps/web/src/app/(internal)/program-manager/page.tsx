              ...
              <Card className="mentor-card">
                <CardContent className="flex items-center gap-4 bg-white p-5">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="font-manrope text-text-muted-custom text-xs">{stats.activePrograms} active</p>
                  </div>
                </CardContent>
              </Card>
                    ...
                    {stats.recentApplications.map((app) => (
                      <div key={app.id} className="flex items-center">
                        ...
                        <div className="ml-4 space-y-1">
                          <p className="font-manrope font-medium text-sm text-text-main leading-none">
                            {app.user?.name}
                          </p>

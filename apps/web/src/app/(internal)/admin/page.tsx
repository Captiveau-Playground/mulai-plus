...
// Recharts di-load on-demand (ssr: false) — hemat ~368KB dari render awal halaman admin
const AdminDashboardCharts = dynamic(
  () => import("@/components/admin/dashboard-charts").then((m) => m.AdminDashboardCharts),
  {
    ssr: false,
    loading: () => (
      <div className="grid gap-4 lg:grid-cols-5">
        <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white p-4 shadow-xs lg:col-span-3">
  ...
  return (
    <PageState isLoading={isAuthLoading} isAuthorized={isAuthorized}>
      <div className="space-y-5 p-4">
        ...
        {/* ── Charts Row (recharts di-lazy-load) ── */}
        <AdminDashboardCharts stats={stats} analytics={analytics}>
          <AuditTrailMini />

                          ...
                          <CardContent className="border-gray-100 border-t bg-white pt-4">
                            ...
                            {session.attachments && session.attachments.length > 0 && (
                              <div className="mt-4 border-gray-100 border-t pt-4">
                                <p className="mb-3 flex items-center gap-1.5 font-manrope font-semibold text-text-main text-xs uppercase tracking-wider">
                                  <svg
                                    className="h-4 w-4"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                ...
                                <div className="flex flex-wrap gap-2">
                                  {session.attachments.map((att: any) => (
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="inline-flex items-center gap-1.5 rounded-lg border border-brand-navy/20 bg-brand-navy/5 px-3 py-2 font-manrope font-medium text-brand-navy text-xs shadow-sm transition-all hover:bg-brand-navy/10 hover:shadow-md"
                                    >
                                      <svg

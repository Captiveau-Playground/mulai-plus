...
const STATS = [
  { value: "20", label: "soal terukur" },
  { value: "10", label: "menit selesai" },
  { value: "18.000+", label: "prodi dicocokkan" },
  { value: "6+5", label: "dimensi minat & bakat" },
];
    ...
    <div className="overflow-hidden bg-white">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-6 px-4 py-8 sm:px-6 md:grid-cols-4 lg:px-8">
          {STATS.map((s) => (
            <div key={s.label} className="text-center">
              <p className="font-bold font-bricolage text-3xl text-brand-navy md:text-4xl">{s.value}</p>
      ...
      <section id="untuk-sekolah" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-24 lg:px-8">
        ...
        <div className="mx-auto mt-12 grid max-w-4xl gap-5 md:grid-cols-2">
          ...
          <div className="flex flex-col rounded-2xl border border-gray-200 bg-white p-8">
            <div className="flex items-center gap-2">
              <span className="rounded-full bg-gray-100 px-3 py-1 font-bold font-manrope text-[11px] text-gray-600">
                UNTUK DIRI SENDIRI
              </span>
      ...
      <section className="border-gray-100 border-t">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-20 lg:px-8">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-navy to-brand-navy-light px-8 py-12 text-center md:px-12 md:py-16">
            <div
